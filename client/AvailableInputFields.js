...
var AvailableInputFields = React.createClass({
	render: function () {
	console.log(this.props, "props of availableinputfields");
		...
		return (
			<div>
	          <div className="flex">
		        ...
		        <input name= {this.props.token.tokenDisplayName} className={`text-input width--200 text-input-styled ${error}`} placeholder={this.props.token.placeholder} value={this.props.token.value} onChange={this.props.onChange}/>

		...
		return (
			<div>
	          <div className="flex">
		        ...
		        <input className={`text-input width--200 text-input-styled ${error}`} placeholder={this.props.token.placeholder} value={this.props.token.value} onChange={this.props.onChange}/>
